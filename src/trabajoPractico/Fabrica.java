...
/*--------------------------------------------------------------*/
		...
		private Map<String, String[]> generarPaisesPorMundial() {
			...
			ret.put("España '82", new String[] { "Italia", "Alemania" });
			...
			ret.put("Corea del Sur y Japón '02", new String[] { "Brasil", "Alemania" });
			ret.put("Alemania '06", new String[] { "Italia", "Francia" });
			ret.put("Sudáfrica '10", new String[] { "España", "Países Bajos" });
